...
#define DEFINE_STATIC_EVENT_TYPE(type)         static constexpr EventType     getStaticType()     { return type; }
#define DEFINE_STATIC_EVENT_CATEGORY(category) static constexpr EventCategory getStaticCategory() { return category; }
